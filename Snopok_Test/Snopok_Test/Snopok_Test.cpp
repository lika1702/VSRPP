...
// Snopok_Test.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSnopok_TestApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CSnopok_TestApp

CSnopok_TestApp::CSnopok_TestApp()
{
...
// Единственный объект CSnopok_TestApp

CSnopok_TestApp theApp;


// инициализация CSnopok_TestApp

BOOL CSnopok_TestApp::InitInstance()
{
