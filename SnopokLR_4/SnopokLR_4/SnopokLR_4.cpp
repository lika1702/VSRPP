...
// SnopokLR_4.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSnopokLR_4App, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CSnopokLR_4App::OnAppAbout)
	// Стандартная команда настройки печати
	ON_COMMAND(ID_FILE_PRINT_SETUP, &CWinAppEx::OnFilePrintSetup)
END_MESSAGE_MAP()


// создание CSnopokLR_4App

CSnopokLR_4App::CSnopokLR_4App()
{
	...
	SetAppID(_T("SnopokLR_4.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CSnopokLR_4App

CSnopokLR_4App theApp;


// инициализация CSnopokLR_4App

BOOL CSnopokLR_4App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CSnopokLR_4Doc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CSnopokLR_4View));
	if (!pDocTemplate)
		return FALSE;
...
int CSnopokLR_4App::ExitInstance()
{
...
// обработчики сообщений CSnopokLR_4App
...
void CSnopokLR_4App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CSnopokLR_4App настройка методов загрузки и сохранения

void CSnopokLR_4App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CSnopokLR_4App::LoadCustomState()
{
}

void CSnopokLR_4App::SaveCustomState()
{
}
