...
// SnopokLR_8.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSnopokLR_8App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CSnopokLR_8App

CSnopokLR_8App::CSnopokLR_8App()
{
...
// Единственный объект CSnopokLR_8App

CSnopokLR_8App theApp;


// инициализация CSnopokLR_8App

BOOL CSnopokLR_8App::InitInstance()
{
