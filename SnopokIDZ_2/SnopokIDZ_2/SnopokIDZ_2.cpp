...
// SnopokIDZ_2.cpp : Определяет поведение классов для приложения.
//
...
// Единственный объект CSnopokIDZ_2App

CSnopokIDZ_2App theApp;


// инициализация CSnopokIDZ_2App
...
// обработчики сообщений CSnopokIDZ_2App
...
// CSnopokIDZ_2App настройка методов загрузки и сохранения
