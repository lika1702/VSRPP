...
// SnopokIDZ.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSnopokIDZApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CSnopokIDZApp::OnAppAbout)
...
// Создание CSnopokIDZApp

CSnopokIDZApp::CSnopokIDZApp() noexcept
{
	...
	SetAppID(_T("SnopokIDZ.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CSnopokIDZApp

CSnopokIDZApp theApp;


// Инициализация CSnopokIDZApp

BOOL CSnopokIDZApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CSnopokIDZDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CSnopokIDZView));
	if (!pDocTemplate)
		return FALSE;
...
int CSnopokIDZApp::ExitInstance()
{
...
// Обработчики сообщений CSnopokIDZApp
...
void CSnopokIDZApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Методы загрузки или сохранения настроек CSnopokIDZApp

void CSnopokIDZApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CSnopokIDZApp::LoadCustomState()
{
}

void CSnopokIDZApp::SaveCustomState()
{
}
