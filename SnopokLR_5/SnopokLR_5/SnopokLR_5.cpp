...
// SnopokLR_5.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSnopokLR_5App, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CSnopokLR_5App::OnAppAbout)
	// Стандартная команда настройки печати
	ON_COMMAND(ID_FILE_PRINT_SETUP, &CWinAppEx::OnFilePrintSetup)
END_MESSAGE_MAP()


// создание CSnopokLR_5App

CSnopokLR_5App::CSnopokLR_5App()
{
	...
	SetAppID(_T("SnopokLR_5.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CSnopokLR_5App

CSnopokLR_5App theApp;


// инициализация CSnopokLR_5App

BOOL CSnopokLR_5App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CSnopokLR_5Doc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CSnopokLR_5View));
	if (!pDocTemplate)
		return FALSE;
...
int CSnopokLR_5App::ExitInstance()
{
...
// обработчики сообщений CSnopokLR_5App
...
void CSnopokLR_5App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CSnopokLR_5App настройка методов загрузки и сохранения

void CSnopokLR_5App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CSnopokLR_5App::LoadCustomState()
{
}

void CSnopokLR_5App::SaveCustomState()
{
}
